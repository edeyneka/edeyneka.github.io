...
2. [LinkedIn](/posts/2022/04/linkedin)
...
4. **Brute-force.** Some people can freeze because they do not know how to find an optimal solution to a particular task. Threfore, firstly, discuss **any** approach even if its complexity is O($k^n$). Once again, it is about being not silent. Depending on the situation, you can code your simple solution, or your interviewer can be satisfied with just an explanation. After that, you can start discussing that there could be some other more elegant solutions and maybe they come to your mind at that point, or your interviewer will give you some hints.
